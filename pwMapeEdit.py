...
class pwMapeditPy(QMainWindow):
    ...
    map_scale_km = (100, 84, 71, 60, 50, 42, 35, 29, 24, 20, 17, 14, 12, 10, 8.4, 7.1, 6, 5, 4.2, 3.5, 2.9, 2.4, 2, 1.7,
                    1.4, 1.2, 1, 0.84, 0.71, 0.6, 0.5, 0.42, 0.35, 0.29, 0.24, 0.2, 0.17, 0.14, 0.12, 0.1, 0.084, 0.071,
                    0.06, 0.05, 0.042, 0.035, 0.029, 0.024, 0.02, 0.017, 0.014, 0.012, 0.01, 0.0084, 0.0071, 0.006,
                    0.005, 0.0042, 0.0035, 0.0029, 0.0024, 0.0020, 0.0017, 0.0014, 0.0012, 0.0010)
