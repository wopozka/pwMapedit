...
class pwMapeditPy(QMainWindow):
    ...
    def _create_edit_actions(self):
        ...
        edit_actions[-1].setShortcut(QKeySequence.StandardKey.Undo)
        ...
        edit_actions[-1].setShortcut(QKeySequence.StandardKey.Redo)
        edit_actions.append(None)
        edit_actions.append(QAction('&Cut', self))
        edit_actions[-1].setShortcut(QKeySequence.StandardKey.Cut)
        edit_actions.append(QAction('&Copy', self))
        edit_actions[-1].setShortcut(QKeySequence.StandardKey.Copy)
        edit_actions[-1].triggered.connect(self.copy_action)
        edit_actions.append(QAction('&Paste', self))
        edit_actions[-1].setShortcut(QKeySequence.StandardKey.Paste)
        ...
        edit_actions[-1].setShortcut(QKeySequence.StandardKey.Delete)
